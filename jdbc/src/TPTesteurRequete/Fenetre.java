...
import TPTesteurRequete.Connection3;
  ...
  */
  public void initTable(String query){
    ...
    //On crée un statement
      ...
      Statement state = Connection3.getInstance().createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
